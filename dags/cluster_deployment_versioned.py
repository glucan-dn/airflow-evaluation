...
from airflow_tasks.deployment_tasks_versioned import decide_version_fn, download_stack_new_version_fn
...
dag = DAG(
    'cluster_deployment_versioned',
    default_args=default_args,
    # default_queue='worker_1999c8c59930',  # This will target worker 35f5723d0861 worker_2 or 1999c8c59930 worker_1
...
download_stack_new_version = PythonVirtualenvOperator(
    task_id='download_stack_v2.0.0',
    python_callable=download_stack_new_version_fn,
    requirements=['pandas==2.1.4'],
    system_site_packages=True,
    dag=dag,
)
...
branch_decision = BranchPythonOperator(
    ...
    python_callable=decide_version_fn,
)

# Set task dependencies and order
pre_deployment_checks >> branch_decision >> [download_stack, download_stack_new_version]
download_stack >> run_pre_check
download_stack_new_version >> run_pre_check
run_pre_check >> wait_for_tests_to_run >> deploy_stack >> finish_download